...
<head>
<meta charset="utf-8">
<title>年代列表-分类管理-涂涂影院后台管理系统-Powered by Jeenotes! X1.0</title>
</head>
							...
							<table id="table" class="table">
								...
								<tbody>
									<c:choose>
										...
										<c:otherwise>
											<c:forEach items="${videoTimeList}" var="entity" varStatus="status" >
												<tr>
													<td><input type="checkbox" class="fill listen-1-2" name="id" value="${entity.time_id}" /> </td>
													<td>${entity.sort}</td>
													<td>${entity.name}</td>
													<td>
