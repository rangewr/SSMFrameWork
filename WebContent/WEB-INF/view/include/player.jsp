...
<script type="text/javascript">
			...
			var videoObject = {
				...
				cktrack: '${ctxStatic}/player/material/srt.srt', //字幕文件
				poster: '${ctxStatic}/player/material/poster.jpg', //封面图片
				preview: { //预览图片
					file: ['${ctxStatic}/player/material/mydream_en1800_1010_01.png', '${ctxStatic}/player/material/mydream_en1800_1010_02.png'],
					scale: 2
				},
				config: '', //指定配置函数
				debug: true, //是否开启调试模式
